  ...
  return (
    <div className="absolute bottom-4 left-4 z-10 p-4 rounded-lg w-72"
      ...
      <div style={{ borderTop: '1px solid var(--color-border)', marginTop: '6px', paddingTop: '6px' }}>
        ...
        <ToggleButton label={de ? "Edge-Farben" : "Edge Colors"}
          value={settings.showEdgeColors}
          onChange={v => onUpdate('showEdgeColors', v)} />        <ToggleButton label={de ? "Cluster-Puls" : "Cluster Pulse"}
