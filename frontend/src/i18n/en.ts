...
const en = {
  ...
  delphi: {
    ...
    delete: 'Delete',
    deleteConfirm: 'Really delete this conversation?',
    inputPlaceholder: 'Ask Delphi…',
    send: 'Send',
    sending: 'Generating answer…',
    confidenceHigh: 'Well sourced',
    confidenceMedium: 'Partially sourced',
    confidenceLow: 'General knowledge',
    confidenceTooltipHigh: 'Answer is well backed by Pallas sources',
    confidenceTooltipMedium: 'Answer is only partially backed by Pallas sources',
    confidenceTooltipLow: 'No matching Pallas sources — answer from general knowledge',
    source: 'Source',
    sources: 'Sources',
    unverifiedClaim: 'Not covered by Pallas sources',
    noSourcesUsed: 'No Pallas sources used',
    viewSource: 'View source',
    emptyChat: 'Ask your first question. Delphi searches your knowledge and answers what it finds.',
    errorGeneric: 'Something went wrong.',
    errorSendFailed: 'Could not generate answer.',
  },
